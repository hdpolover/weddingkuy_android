...
public class FotografiFragment extends Fragment {
    ...
    String kategori = "Fotografi";

    LinearLayout noData;

    public FotografiFragment() {
        // Required empty public constructor
    }

    public static FotografiFragment newInstance(String param1, String param2) {
        FotografiFragment fragment = new FotografiFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_foto_container, container, false);

...
public class WoFragment extends Fragment {
    ...
    String kategori = "Wedding Organizer (WO)";

    public WoFragment() {
        // Required empty public constructor
    }

    public static WoFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_wo_container, container, false);
